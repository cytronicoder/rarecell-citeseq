...
same cells. This makes them powerful for distinguishing immune cell types and fine-grained cellular states. However,
multimodal integration methods are usually evaluated on broad objectives such as clustering, batch correction, modality
prediction, or global cell-type separation. Large benchmarks already compare many single-cell multimodal integration
algorithms, including broad studies across RNA, protein, ATAC, DNA, and spatial modalities.
